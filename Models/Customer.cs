...
namespace Boat_Rental.Models
{
    public partial class Customer
    {
        ...
        public Customer(string firstNameCustomer, string lastNameCustomer, DateTime ageCustomer, string mailCustomer, bool boatLicenseCustomer, bool hasRentedCustomer)
        {
